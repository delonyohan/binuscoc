            ...
            <aside className="w-64 bg-slate-900 flex flex-col fixed h-full z-10 shadow-2xl">
                <div className="p-6">
                    <div className="flex items-center gap-3 text-white">
                        <div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center font-bold shadow-lg shadow-blue-900/20">S</div>
                ...
                <nav className="flex-1 px-4 space-y-2 mt-4">
                    ...
                    <NavLink to="/metrics" icon="fa-chart-bar" label="Metrics" />
