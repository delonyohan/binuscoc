            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-8 flex justify-between items-end">
                    <div>
                        ...
                        <p className="text-slate-500 mt-1">Performance metrics and architecture analysis of the active model.</p>
                    </div>
                ...
                <div className="space-y-6">
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center py-2 border-b border-slate-100">
                                        ...
                                        <span className="font-mono text-sm font-bold text-slate-800 bg-slate-100 px-2 py-1 rounded">YOLOv8n-Seg</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b border-slate-100">
                            ...
                            <CardContent>
                                <div className="flex gap-4 h-64">
                                    ...
                                    <div className="w-48 bg-slate-50 rounded-lg p-3 flex flex-col gap-2">
                                        ...
                                        <div className="flex items-center gap-2 text-xs"><div className="w-3 h-3 bg-red-500 rounded-full"></div> High (Lower Body)</div>
                                        <div className="flex items-center gap-2 text-xs"><div className="w-3 h-3 bg-yellow-400 rounded-full"></div> Med (Footwear)</div>
                                        <div className="flex items-center gap-2 text-xs"><div className="w-3 h-3 bg-transparent border border-slate-300 rounded-full"></div> Low (Background)</div>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <Card>
                            <CardHeader><CardTitle className="text-lg flex items-center gap-2"><i className="fas fa-chart-bar text-blue-500"></i> Performance Benchmarks</CardTitle></CardHeader>
                            <CardContent className="h-64">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={BENCHMARK_DATA} layout="vertical" margin={{ top: 5, right: 30, left: 40, bottom: 5 }}>
                        ...
                        <Card>
                             <CardHeader><CardTitle className="text-lg flex items-center gap-2"><i className="fas fa-project-diagram text-purple-500"></i> Fine-Grained Lexicon</CardTitle></CardHeader>
                            <CardContent className="h-64">
                                <ResponsiveContainer width="100%" height="100%">
                        ...
                        <Card>
                            <CardHeader><CardTitle className="text-lg flex items-center gap-2"><i className="fas fa-tachometer-alt text-red-500"></i> Latency vs Load</CardTitle></CardHeader>
                            <CardContent className="h-64">
                                <ResponsiveContainer width="100%" height="100%">
